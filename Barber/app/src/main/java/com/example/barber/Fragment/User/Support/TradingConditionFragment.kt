 ...
 * Use the [TradingConditionFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class TradingConditionFragment : Fragment() {
    ...
    private var type = "Điều kiện giao dịch"
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_trading_condition, container, false)
        init(view)
        back()
        hideBottom()
        getPost()
    ...
    private fun setUpRV() {
        ...
        postNoImgAdapter.setOnClickListener(object : PostNoImgAdapter.onItemClicklistener{
            override fun onClickView(position: Int) {
                ...
                controller.navigate(R.id.action_tradingConditionFragment_to_viewOnePostNoImgFragment,bundle)
            }
    ...
    private fun back() {
        imvBack.setOnClickListener(View.OnClickListener {
            controller.navigate(R.id.action_tradingConditionFragment_to_supportFragment)
        })
    }
    ...
    private fun init(view: View) {
        ...
        rv = view.findViewById(R.id.tradingConditionF_recyclerView)
        imvBack = view.findViewById(R.id.tradingConditionF_imv_back)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment TradingConditionFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            TradingConditionFragment().apply {

 ...
 * Use the [HairTrendingFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class HairTrendingFragment : Fragment() {
    ...
    private var typePost = "Xu hướng hot nhất"
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_hair_trending, container, false)
        init(view)
        hideNavi()
        getPost()
        back()
    ...
    private fun back() {
        imvBack.setOnClickListener(View.OnClickListener {
            controller.navigate(R.id.action_hairTrendingFragment_to_knowledgeFragment)
        })
    }
        ...
        postImgAdapter.setOnClickListener(
            object : PostImgAdapter.onItemClicklistener{
                override fun onClickView(position: Int) {
                    ...
                    controller.navigate(R.id.action_hairTrendingFragment_to_viewOnePostFragment,bundle)
                }
    ...
    private fun init(view: View) {
        ...
        imvBack = view.findViewById(R.id.hairTrendingF_imv_back)
        rv = view.findViewById(R.id.hairTrendingF_recyclerView)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment HairTrendingFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            HairTrendingFragment().apply {

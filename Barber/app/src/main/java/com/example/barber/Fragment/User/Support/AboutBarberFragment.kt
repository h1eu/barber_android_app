 ...
 * Use the [AboutBarberFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class AboutBarberFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_about_barber, container, false)
        init(view)
        back()
        hideBottom()
        getPost()
    ...
    private fun setUpRV() {
        ...
        postNoImgAdapter.setOnClickListener(object : PostNoImgAdapter.onItemClicklistener{
            override fun onClickView(position: Int) {
                ...
                controller.navigate(R.id.action_aboutBarberFragment2_to_viewOnePostNoImgFragment,bundle)
            }
    ...
    private fun back() {
        imvBack.setOnClickListener(View.OnClickListener {
            controller.navigate(R.id.action_aboutBarberFragment2_to_supportFragment)
        })
    }
    ...
    private fun init(view: View) {
        ...
        rv = view.findViewById(R.id.aboutBarberF_recyclerView)
        imvBack = view.findViewById(R.id.aboutBarberF_imv_back)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment AboutBarberFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AboutBarberFragment().apply {

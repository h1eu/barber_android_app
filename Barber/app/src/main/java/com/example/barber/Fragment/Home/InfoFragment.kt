...
class InfoFragment : Fragment() {
    ...
    private fun back() {
        imvBack.setOnClickListener(View.OnClickListener {
            controller.navigate(R.id.action_infoFragment_to_homeFragment)
        })
    }
    ...
    private fun setUpRV() {
        ...
        postNoImgAdapter.setOnClickListener(object : PostNoImgAdapter.onItemClicklistener{
            override fun onClickView(position: Int) {
                ...
                controller.navigate(R.id.action_infoFragment_to_viewOnePostNoImgFragment,bundle)
            }
    ...
    private fun init(view: View) {
        ...
        rv = view.findViewById(R.id.infoF_recyclerView)
        imvBack = view.findViewById(R.id.infoF_imv_back)
    }

 ...
 * Use the [PriceListMenFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class PriceListMenFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view =inflater.inflate(R.layout.fragment_price_list_men, container, false)
        init(view)
        getPost()
        return view
    }
    ...
    private fun init(view: View) {
        ...
        rv = view.findViewById(R.id.priceListMenF_recyclerView)
    ...
    companion object {
         ...
         * @return A new instance of fragment PriceListMenFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PriceListMenFragment().apply {

 ...
 * Use the [InfoSecurityFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class InfoSecurityFragment : Fragment() {
    ...
    private var type = "Chính sách bảo mật thông tin"
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_info_security, container, false)
        init(view)
        back()
        hideBottom()
        getPost()
    ...
    private fun setUpRV() {
        ...
        postNoImgAdapter.setOnClickListener(object : PostNoImgAdapter.onItemClicklistener{
            override fun onClickView(position: Int) {
                ...
                controller.navigate(R.id.action_infoSecurityFragment_to_viewOnePostNoImgFragment,bundle)
            }
    ...
    private fun back() {
        imvBack.setOnClickListener(View.OnClickListener {
            controller.navigate(R.id.action_infoSecurityFragment_to_supportFragment)
        })
    }
    ...
    private fun init(view: View) {
        ...
        rv = view.findViewById(R.id.infoSecuF__recyclerView)
        imvBack = view.findViewById(R.id.infoSecuF_imv_back)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment InfoSecurityFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            InfoSecurityFragment().apply {

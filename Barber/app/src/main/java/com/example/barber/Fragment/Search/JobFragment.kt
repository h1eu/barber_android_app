...
class JobFragment : Fragment() {
    ...
    private var typePost = "Tuyển dụng"
    ...
    private fun back() {
        imvBack.setOnClickListener(View.OnClickListener {
            controller.navigate(R.id.action_jobFragment_to_searchFragment)
        })
    }
    ...
    private fun setUpRV() {
        ...
        postImgAdapter.setOnClickListener(
            object : PostImgAdapter.onItemClicklistener{
                override fun onClickView(position: Int) {
                    ...
                    controller.navigate(R.id.action_jobFragment_to_viewOnePostFragment,bundle)
                }
        ...
        private fun init(view : View){
            ...
            imvBack = view.findViewById(R.id.jobF_imv_back)
            rv = view.findViewById(R.id.jobF_recyclerView)
        }

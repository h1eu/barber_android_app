 ...
 * Use the [OrderComfirmFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class OrderComfirmFragment : Fragment() {
    ...
    private lateinit var listComfirmOrder : ArrayList<ProductInBill>
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_order_comfirm, container, false)
        init(view)
                ...
                override fun onResponse(
                    ...
                    if(list != null){
                        ...
                        for(i in 0 until listR.size){
                            listComfirmOrder.add(listR.get(i))
                        }
                        setupRv()
                    }
                }
    ...
    private fun setupRv(){
        ...
        val orderComfirmAdapter = OrderComfirmAdapter(listComfirmOrder,requireContext())
        rv.layoutManager = linearLayoutManager
        rv.adapter = orderComfirmAdapter
        orderComfirmAdapter.setOnClickListener(
            object  : OrderComfirmAdapter.onItemClicklistener{
                override fun onClickView(position: Int) {
                    var bundle = bundleOf(
                        "order" to listComfirmOrder.get(position),
    ...
    private fun init(view: View) {
        ...
        rv = view.findViewById(R.id.orderComfrimF_recyclerView)
        listComfirmOrder = arrayListOf()
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment OrderComfirmFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            OrderComfirmFragment().apply {
